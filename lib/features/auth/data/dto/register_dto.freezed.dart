...
class _$RegisterDtoImpl extends _RegisterDto {
  const _$RegisterDtoImpl({required this.id, required this.token}) : super._();
  ...
  @override
  String toString() {
    return 'RegisterDto(id: $id, token: $token)';
  }
...
abstract class _RegisterDto extends RegisterDto {
  const factory _RegisterDto(
      {required final int id, required final String token}) = _$RegisterDtoImpl;
